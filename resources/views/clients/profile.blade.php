                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <h6 class="text-muted">{{$client->first_name .' '.$client->last_name}}</h6>
                                            <small class="text-muted">{{$client->contact_person}}</small>
                                            <div class="staff-id text-uppercase">Client ID :
                                                CLT-{{$client->client_id}}
                                            </div>
                                            <div class="small doj text-muted">Date of Join : {{$client->hire_date}}
                                            </div>
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            ...
                                            <li>
                                                ...
                                                <div class="text"><a href="">{{$client->user->email}}</a></div>
                                            </li>
                                            <!--                                            <li>-->
            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item col-sm-3"><a href="#myprojects" data-toggle="tab" class="nav-link active">Projects</a>
                        </li>
                        <li class="nav-item col-sm-3"><a href="#tasks" data-toggle="tab"
                                                         class="nav-link">Tasks</small></a></li>
                    </ul>
                </div>
            </div>
        </div>
