                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt="" src="{{asset($employee->user->profile_image)}}"></a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <h6 class="text-muted">{{$employee->position->position_name}}</h6>
                                            <small class="text-muted">{{$employee->department->department_name}}</small>
                                            <div class="staff-id">Employee ID : FT-{{$employee->employee_id}}</div>
                                            <div class="small doj text-muted">Date of Join : {{$employee->hire_date}}</div>
