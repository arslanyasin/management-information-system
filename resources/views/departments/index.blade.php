    ...
    <div class="content container-fluid">
        ...
        <div class="row text-end">
            <div class="col-12 mb-3 mt-3">
                <a href="{{ route('departments.create') }}" class="btn add-btn">+ Add Department</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="confirm-delete-form" action="{{ route('departments-delete') }}" class="d-inline btn-ok" method="post">
                    @csrf
